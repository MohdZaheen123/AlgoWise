...
export default function Component() {
  return (
    ...
    <div className="min-h-screen shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.3)] flex flex-col py-20  mx-auto lg:w-[75%]">
      <p className="bg-clip-text text-transparent bg-gradient-to-r from-sky-600 to-pink-500 text-center text-3xl font-bold">Explore And Learn Devs!!</p>
            <div className="w-[95%]  mx-auto flex flex-col lg:flex-row  justify-center items-center pt-10">
                ...
                <video src="default.mp4" autoPlay loop muted className=" w-[80%] lg:w-[47%] rounded-xl border border-blue-900 mt-3"></video>
            </div>
            ...
            <div className="w-[95%] mx-auto flex flex-col-reverse lg:flex-row  justify-center items-center mt-20 pt-10">
               ...
               <img src="keyboard.png" className="w-[95%]  lg:w-[63%] rounded-lg border mt-5 border-blue-900" alt="" />
            ...
            <div className="flex flex-col justify-center items-center   mt-20 pt-10">
               ...
               <video src="world3.mp4" autoPlay loop muted className=" w-[90%] rounded-xl mt-5"></video>
            </div>
        </div>
    </div>
  )
