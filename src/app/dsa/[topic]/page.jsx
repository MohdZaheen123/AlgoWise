...
export default async  function page({params}) {
  ...
  return (
    <div className=' flex-wrap flex '>
        ...
        {posts.map((post) => (
            <Link href={`/dsa/${topic}/${post.slug}`} key={post.slug} className="w-96  group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 my-3 pb-7 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
